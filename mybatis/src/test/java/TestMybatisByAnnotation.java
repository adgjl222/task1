import com.mybatis.dao.StudentMapperByAnnotation;
...
public class TestMybatisByAnnotation {
    ...
    SqlSession session = MybatisUtil.creatSqlSession();
    StudentMapperByAnnotation mapper = session.getMapper(StudentMapperByAnnotation.class);
    ...
    public void testUpdate(){
        ...
        int a = 0;
        try {
            a = mapper.updateStudent(student);
            session.commit();
            if (a == 1){
                update = true;
                log.info("数据更新成功");
